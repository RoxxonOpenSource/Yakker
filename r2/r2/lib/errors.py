...
error_list = dict((
        ...
        ('SUBREDDIT_EXISTS', _('that community already exists')),
        ('SUBREDDIT_NOEXIST', _('that community doesn\'t exist')),
        ('SUBREDDIT_NOTALLOWED', _("you aren't allowed to post there.")),
        ('SUBREDDIT_NO_ACCESS', _("you aren't allowed access to this community")),
        ('SUBREDDIT_REQUIRED', _('you must specify a community')),
        ('SUBREDDIT_DISABLED_ADS', _('this community has chosen to disable their ads at this time')),
        ...
        ('OVERSOLD', _('that community has already been oversold on %(start)s to %(end)s. Please pick another community or date.')),
        ...
        ('NO_SELFS', _("that community doesn't allow text posts")),
        ('NO_LINKS', _("that community only allows text posts")),
        ...
        ('NO_INVITE_FOUND', _('there is no pending invite for that community')),
        ...
        ('MULTI_SPECIAL_SUBREDDIT', _("can't add special community %(path)s")),
        ...
        ('BANNED_FROM_SUBREDDIT', _('that user is banned from the community')),
        ...
        ('GILDING_NOT_ALLOWED', _("gilding is not allowed in this community")),
        ('SCRAPER_ERROR', _("unable to scrape provided url")),
        ('NO_SR_TO_SR_MESSAGE', _("can't send a message from a community to another community")),
        ('USER_BLOCKED_MESSAGE', _("can't send message to that user")),
        ('ADMIN_REQUIRED', _("you must be in admin mode for this")),
        ('CANT_CONVERT_TO_GOLD_ONLY', _("to convert an existing community to gold only, send a message to %(admin_modmail)s") 
            % dict(admin_modmail=g.admin_message_acct)),
        ('GOLD_ONLY_SR_REQUIRED', _("this community must be 'gold only' to select this")),
        ('CANT_CREATE_SR', _("your account is too new or you do not have enough karma to create a community. please contact the admins to request an exemption.")),
        ...
        ('USER_MUTED', _("You have been muted from this community.")),
        ('MUTED_FROM_SUBREDDIT', _("This user has been muted from the community.")),
        ('COMMENT_NOT_STICKYABLE', _("This comment is not stickyable. Ensure that it is a top level comment.")),
        ('SR_RULE_EXISTS', _("A community rule by that name already exists.")),
        ('SR_RULE_DOESNT_EXIST', _("No community rule by that name exists.")),
        ('SR_RULE_TOO_MANY', _("This community already has the maximum number of rules.")),
